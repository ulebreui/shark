module units
  ...
  !   real(dp),parameter :: unit_d = mH*mu_gas !To convert rho into nH For the moment : not used
  ...
  !real(dp),parameter :: unit_B =1./(4.d0*pi*unit_d*(unit_v)**2)
    ! real(dp),parameter :: unit_B = dsqrt(4*pi*unit_d)*unit_v !If 4pi appears here, should not appear in the def of B_cell
    real(dp),parameter :: unit_B = 1.0d0 !If 4pi appears here, should not appear in the def of B_cell
