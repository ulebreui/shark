...
subroutine solver_induction_llf(qleft,qright,flx,csl,csr,idim)
    use parameters
    use commons
...
subroutine solver_induction_Huang_Bai(qleft,qright,flx,idim)
    use parameters
    use commons
...
subroutine solver_induction_hll(qleft,qright,flx,csl,csr,idim)
    use parameters
    use commons
