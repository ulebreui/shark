...
end subroutine res_electrons_ions
...
subroutine total_current
  ...
  do i=1,ncells
    ...
    do i=1,ncells
        ...
        Jy(i) = -dxBz !Beware: note that there is a c/4pi missing. Not a current strictly speaking.
        Jz(i) = dxBy
...
#if MHD==1
#if NDUST>0
subroutine total_dust_current
!This current is correct units.
  use parameters
  use commons
  use units
  !use OMP_LIB 
